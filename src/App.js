      ...
      <div>
        <StickyBox>
          <div
            ...
            } fixed z-40  flex-none overflow-y-scroll h-full bg-black bg-opacity-25 w-full lg:bg-white lg:static  sm:overflow-y-visible lg:pt-0 lg:w-72 xl:w-72 lg:visible`}
          >
            <div
              ref={wrapperRef}
              id="navWrapper"
            ...
            >
              {" "}
              <Sidebar_button class="visible" ref={wrapperRef} active={active} setActive={setActive} />
